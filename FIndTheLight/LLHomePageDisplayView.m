...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _LLHomeDisplayLabel.frame = CGRectMake(10, 5, self.bounds.size.width*0.8547,
                                               self.bounds.size.height*0.333);
        ...
        _LLHomeDisplayLabel.text = @"正在定位中";
        ...
        LocationLabel.frame = CGRectMake(0,self.bounds.size.height/2 , self.bounds.size.width,
